...
[DependsOn(
    typeof(CustomerManagement.CustomerManagementDomainModule),
    typeof(ProjectManagement.ProjectManagementDomainModule)
)]
public class ModulesEntitySyncDomainModule : AbpModule
{
